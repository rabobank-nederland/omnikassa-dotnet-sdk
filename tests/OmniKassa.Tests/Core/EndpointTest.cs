...
namespace omnikassa_dotnet_test.Core
{
    public class EndpointTest
    {
        ...
        [Fact]
        public async Task InitiateRefundTransaction_WithValidToken_ReturnsRefundDetails()
        {
            ...
            var result = await endpoint.InitiateRefundTransactionAsync(refundRequest, transactionId, requestId);
        ...
        [Fact]
        public async Task InitiateRefundTransaction_WithInvalidToken_RetrievesNewTokenAndRetries()
        {
            var transactionId = Guid.NewGuid();
            var requestId = Guid.NewGuid();
        ...
        [Fact]
        public async Task FetchRefundTransaction_WithInvalidToken_RetriesAfterRefresh()
        {
            var transactionId = Guid.NewGuid();
            ...
            var result = await endpoint.FetchRefundTransactionAsync(transactionId, refundId);
        ...
        [Fact]
        public async Task FetchRefundableTransactionDetails_WithInvalidToken_RetriesAfterRefresh()
        {
            var transactionId = Guid.NewGuid();
            var oldToken = "old-token";
            var newToken = new AccessToken("refreshed", DateTime.UtcNow.AddHours(1), 3600);
            ...
            var result = await endpoint.FetchRefundableTransactionDetailsAsync(transactionId);
